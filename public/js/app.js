        ...
        fetch("/api/wind-map-data")
            ...
            .then((data) => {
                ...
                if (data) {
                    ...
                    console.error(
                        "Wind data from API is null. The velocity layer cannot be created."
                    );
                }
            })
            .catch((error) =>
        ...
        if (windChartCanvas) {
            fetch("/api/wind-speed-stats")
                ...
                .then((data) => {
                    ...
                    console.log(
                        "Wind speed chart initialized with LIVE API data."
                    );
                })
                .catch((error) =>
        ...
        if (comparisonChartCanvas) {
            fetch("/api/comparison-data")
                ...
                .then((data) => {
                    ...
                    console.log(
                        "Comparison chart initialized with LIVE API data."
                    );
                })
                .catch((error) =>
