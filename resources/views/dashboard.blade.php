...
<body class="bg-gray-100 text-gray-800 flex flex-col min-h-screen">
            ...
            <div class="w-full lg:w-96 bg-white p-6 rounded-xl shadow-lg space-y-6">
                ...
                <div class="bg-blue-50 border border-blue-200 p-4 rounded-lg">
                    ...
                    <p class="text-sm text-blue-700">
                        West Monsoon winds are dominant. Expect increased rainfall in western Java and southern Sumatra for the next 7 days.
                    </p>
                </div>
            </div>
    ...
    <!-- ▼▼▼ TAMBAHKAN BARIS INI ▼▼▼ (PENTING: HARUS SEBELUM leaflet-velocity) -->
