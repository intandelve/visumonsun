...
<body class="bg-gray-100 text-gray-800 flex flex-col min-h-screen">
    ...
    <header class="bg-white shadow-md w-full p-4 flex justify-between items-center z-20">
        ...
        <nav class="hidden md:flex items-center space-x-6">
            <!-- Kita akan perbaiki link ini di Langkah 2 -->
        ...
        <div class="flex items-center space-x-4">
             ...
             @auth
                 @if(Auth::user()->role === 'admin')
                     <a href="{{ route('admin.dashboard') }}" class="text-sm font-medium text-gray-600 hover:text-gray-900">Admin Dashboard</a>
                 @else
