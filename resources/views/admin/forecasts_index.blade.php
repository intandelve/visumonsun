<x-app-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
            ...
            <div class="mb-4">
                <a href="{{ route('admin.forecasts.create') }}" class="inline-block rounded bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700">
                    Add Forecast
                </a>
            </div>
                        ...
                        @foreach ($forecasts as $data)
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-4 py-2 flex items-center space-x-2">
                                    <a href="{{ route('admin.forecasts.edit', $data->id) }}"
