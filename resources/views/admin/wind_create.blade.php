        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="text-2xl font-semibold mb-6">Add New Wind Speed Data</h3>

                    <form method="POST" action="{{ route('admin.wind_data.store') }}">
                        @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <input id="speed_ms" name="speed_ms" type="number" step="0.01" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                        </div>
