        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="text-2xl font-semibold mb-6">Editing: <span class="text-blue-600">{{ $user->name }}</span></h3>
                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user->id) }}">
                        ...
                        <div>
                            ...
                            <input id="name" name="name" type="text" value="{{ $user->name }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required autofocus>
                        </div>

                        <div class="mt-4">
                            <label for="email" class="block font-medium text-sm text-gray-700">Email</label>
                            <input id="email" name="email" type="email" value="{{ $user->email }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                        </div>
