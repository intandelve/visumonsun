            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="text-2xl font-semibold mb-6">
                        Editing data for: <span class="text-blue-600">{{ $rainfall->month_name }}</span>
                    </h3>

                    <form method="POST" action="{{ route('rainfall.update', $rainfall->id) }}">
                        @csrf
                        @method('PATCH')

                        <div>
                            <label for="month_name" class="block font-medium text-sm text-gray-700">Month</label>
                            <input id="month_name" name="month_name" type="text" value="{{ $rainfall->month_name }}" 
                        ...
                        <div class="mt-4">
                            ...
                            <input id="rainfall_mm" name="rainfall_mm" type="number" step="0.01" value="{{ $rainfall->rainfall_mm }}" 
